...
class TestUpdateContract(TestCase):
    ...
    def test_update_existing_contract_valid_payload(self):
        ...
        sleep(10)
        try:
            events_contract_statuses = [
                e["detail"]["contract_status"] for e in get_cw_logs_values(self.eb_log_group, payload["property_id"])
            ]
    ...
    def test_update_missing_contract_invalid_payload_1(self):
        payload = {"add": "St.1 , Building 10", "sell": "John Smith", "prop": "4781231c-bc30-4f30-8b30-7145f4dd1adb"}
    ...
    def test_update_missing_contract_valid_payload(self):
        payload = {"property_id": "usa/some_other_town/street/878828"}
