...
from schema.unicorn_properties_web.publicationapprovalrequested.PublicationApprovalRequested import PublicationApprovalRequested  # noqa: F401,E501

class AWSEvent(object):


    _types = {
        'detail': 'PublicationApprovalRequested',
        'account': 'str',
        'detail_type': 'str',
        'id': 'str',
        'region': 'str',
